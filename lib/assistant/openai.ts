...
- Getting in the pool / swimming as a new session = create_event sport=swim. Atlas picks a free slot.
- If sport + day/part are known, do not ask for an exact clock time.
